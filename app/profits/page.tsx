...
export default function ProfitsPage() {
  ...
  const totalRevenue = profits.reduce((sum, project) => sum + project.totalIncome, 0)
  const totalExpenses = profits.reduce((sum, project) => sum + project.totalExpenses, 0)
  const averageMargin =
    profits.length > 0 ? profits.reduce((sum, project) => sum + project.profitMargin, 0) / profits.length : 0
    ...
    <MainLayout>
      <div className="space-y-6">
        <div>
          ...
          <p className="text-gray-600">Track profitability across all projects</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              ...
              <TrendingUp className={`h-4 w-4 ${averageMargin >= 0 ? "text-green-600" : "text-red-600"}`} />
            </CardHeader>
            <CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Detailed profit breakdown for each project</CardDescription>
          </CardHeader>
          <CardContent>
            {profits.length > 0 ? (
                  ...
                  <div key={project.projectId} className="border rounded-lg p-4">
                    <div className="flex justify-between items-start mb-2">
                      ...
                      <div className="text-right">
                        <p className={`font-bold text-lg ${project.profit >= 0 ? "text-green-600" : "text-red-600"}`}>
                    ...
                    <div className="grid grid-cols-2 gap-4 text-sm">
                      <div>
                        ...
                        <span className="font-medium text-green-600">{formatCurrency(project.totalIncome)}</span>
                      </div>
                      <div>
              ...
              <div className="text-center py-8">
                ...
                <p className="text-gray-400 text-sm">Add projects and transactions to see profit analysis</p>
              </div>
            )}
          </CardContent>
        </Card>
